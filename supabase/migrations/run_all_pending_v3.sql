-- === supabase/migrations/002_about_faq_partners.sql ===
-- ============================================================
...
DROP POLICY IF EXISTS "contact_settings_public_read" ON contact_settings;
CREATE POLICY "contact_settings_public_read" ON contact_settings
  FOR SELECT USING (true);

DROP POLICY IF EXISTS "contact_settings_admin_write" ON contact_settings;
...
CREATE INDEX IF NOT EXISTS idx_faqs_category_sort ON faqs(category, sort_order, is_active);
CREATE INDEX IF NOT EXISTS idx_partners_sort ON partners(sort_order, is_active);

-- ── Triggers ─────────────────────────────────────────────────────────────────

DROP TRIGGER IF EXISTS trg_faqs_updated_at ON _TABLE_PLACEHOLDER_;
CREATE TRIGGER trg_faqs_updated_at
BEFORE UPDATE ON faqs
  FOR EACH ROW EXECUTE FUNCTION update_updated_at();

DROP TRIGGER IF EXISTS trg_partners_updated_at ON _TABLE_PLACEHOLDER_;
CREATE TRIGGER trg_partners_updated_at
BEFORE UPDATE ON partners
  FOR EACH ROW EXECUTE FUNCTION update_updated_at();

DROP TRIGGER IF EXISTS trg_contact_settings_updated_at ON _TABLE_PLACEHOLDER_;
...
-- === supabase/migrations/003_banner_upgrade.sql ===
...
-- === supabase/migrations/004_logistics_settings.sql ===
-- ── logistics_settings ────────────────────────────────────────────────────────
...
DROP TRIGGER IF EXISTS logistics_settings_updated_at ON _TABLE_PLACEHOLDER_;
...
-- === supabase/migrations/005_orders_logistics_status.sql ===
-- ── 物流狀態欄位 ─────────────────────────────────────────────────────────────
...
-- === supabase/migrations/006_payment_settings.sql ===
-- ── 付款設定表 ────────────────────────────────────────────────────────────────
...
DROP TRIGGER IF EXISTS trg_payment_settings_updated_at ON _TABLE_PLACEHOLDER_;
...
DROP POLICY IF EXISTS "payment_settings_public_select" ON payment_settings;
...
DROP POLICY IF EXISTS "payment_transactions_admin_select" ON payment_transactions;
...
-- === supabase/migrations/007_policies.sql ===
-- ── 政策內容表 ────────────────────────────────────────────────────────────────
...
DROP TRIGGER IF EXISTS trg_policies_updated_at ON _TABLE_PLACEHOLDER_;
...
DROP POLICY IF EXISTS "policies_public_select" ON policies;
...
-- 所有 admin 可查看角色列表
DROP POLICY IF EXISTS "admin_roles_admin_select" ON admin_roles;
...
DROP POLICY IF EXISTS "admin_roles_superadmin_mutate" ON admin_roles;
...
-- === supabase/migrations/009_notification_settings.sql ===
-- ── 通知設定 ──────────────────────────────────────────────────────────────────
...
-- === supabase/migrations/010_draft_preview.sql ===
-- ============================================================
...
CREATE INDEX IF NOT EXISTS idx_draft_previews_token    ON draft_previews(preview_token);
CREATE INDEX IF NOT EXISTS idx_draft_previews_resource ON draft_previews(resource_type, resource_id);
CREATE INDEX IF NOT EXISTS idx_draft_previews_expires  ON draft_previews(expires_at) WHERE published_at IS NULL;
...
DROP POLICY IF EXISTS "draft_previews_admin_all" ON draft_previews;
...
-- === supabase/migrations/011_preorder.sql ===
-- ============================================================
