...
VALUES (
  'v0000000-0000-0000-0001-000000000001',
  'p0000000-0000-0000-0000-000000000001',
  '標準版',
  'NFC-CARD-STD',
  590,
...
VALUES
  (
    'v0000000-0000-0000-0002-000000000001',
    'p0000000-0000-0000-0000-000000000002',
    '骨頭形 / 橘色',
    'TAG-BONE-ORG',
    250,
  ...
  (
    'v0000000-0000-0000-0002-000000000002',
    'p0000000-0000-0000-0000-000000000002',
    '圓形 / 銀色',
    'TAG-CIRCLE-SLV',
    250,
  ...
  (
    'v0000000-0000-0000-0002-000000000003',
    'p0000000-0000-0000-0000-000000000002',
    '愛心形 / 玫瑰金',
    'TAG-HEART-RGD',
    280,
...
VALUES
  ('p0000000-0000-0000-0000-000000000002', '形狀', '骨頭形', 1),
  ('p0000000-0000-0000-0000-000000000002', '形狀', '圓形',   2),
  ('p0000000-0000-0000-0000-000000000002', '形狀', '愛心形', 3),
  ('p0000000-0000-0000-0000-000000000002', '顏色', '橘色',   1),
  ('p0000000-0000-0000-0000-000000000002', '顏色', '銀色',   2),
  ('p0000000-0000-0000-0000-000000000002', '顏色', '玫瑰金', 3);
...
INSERT INTO product_variants (id, product_id, name, sku, price, stock, low_stock_threshold, is_active, sort_order)
VALUES (
  'v0000000-0000-0000-0003-000000000001',
  'p0000000-0000-0000-0000-000000000003',
  '組合包（NFC 卡 + 吊牌）',
  'BUNDLE-NFC-TAG',
  790,
